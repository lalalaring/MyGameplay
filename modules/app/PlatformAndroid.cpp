                ...
                case AMOTION_EVENT_ACTION_DOWN:
                    {
                             ...
                             __gestureEventsProcessed.test(Gesture::GESTURE_LONG_TAP))
                        {
                            ...
                            __pointer0.time = System::currentTimeMillis();
                ...
                case AMOTION_EVENT_ACTION_UP:
                    {
					    ...
					    if (__pointer0.pressed &&  __pointer0.pointerId == pointerId && !Form::getActiveControl())
                        {
                            ...
                            // Test for swipe
                                ...
                                gameplay::System::currentTimeMillis() - __pointer0.time < GESTURE_SWIPE_DURATION_MAX && 
                            ...
                            // Test for tap
                                   ...
                                   gameplay::System::currentTimeMillis() - __pointer0.time < GESTURE_TAP_DURATION_MAX)
                            {
                            ...
                            // Test for long tap
                                   ...
                                   gameplay::System::currentTimeMillis() - __pointer0.time >= GESTURE_LONG_TAP_DURATION_MIN)
                            {
                                gameplay::Platform::gestureLongTapEventInternal(x, y, gameplay::System::currentTimeMillis() - __pointer0.time);
                                gestureDetected = true;
                            }    
                        }
                ...
                case AMOTION_EVENT_ACTION_POINTER_DOWN:
                    {
                             ...
                             __gestureEventsProcessed.test(Gesture::GESTURE_LONG_TAP))
                        {
                            ...
                            __pointer1.time = System::currentTimeMillis();
                ...
                case AMOTION_EVENT_ACTION_POINTER_UP:
                    {
                        ...
                        if (__pointer1.pressed &&  __pointer1.pointerId == pointerId && !Form::getActiveControl())
                        {
						    ...
						    // Test for swipe
                                ...
                                gameplay::System::currentTimeMillis() - __pointer1.time < GESTURE_SWIPE_DURATION_MAX && 
                                (abs(deltaX) > GESTURE_SWIPE_DISTANCE_MIN || abs(deltaY) > GESTURE_SWIPE_DISTANCE_MIN) )
                            {
                                int direction = 0;
                                if (deltaX > 0)
                                ...
                                gestureDetected = true;
                                   ...
                                   gameplay::System::currentTimeMillis() - __pointer1.time < GESTURE_TAP_DURATION_MAX)
                            {
                                gameplay::Platform::gestureTapEventInternal(x, y);
                                gestureDetected = true;
                            }
                            else if(__gestureEventsProcessed.test(Gesture::GESTURE_LONG_TAP) &&
                                   gameplay::System::currentTimeMillis() - __pointer1.time >= GESTURE_LONG_TAP_DURATION_MIN)
                            {
                                gameplay::Platform::gestureLongTapEventInternal(x, y, gameplay::System::currentTimeMillis() - __pointer1.time);
                                gestureDetected = true;
                            }    
                        }
							    ...
							    else if (!gestureDetected && pointerId == __pointer0.pointerId)
							    {
								    ...
								    if (__gestureEventsProcessed.test(Gesture::GESTURE_DRAG))
								    {
                                		...
                                		if ((__gestureDraging || __gestureEventsProcessed.test(Gesture::GESTURE_DRAG)) &&
                                     		(gameplay::System::currentTimeMillis() - __pointer0.time >= GESTURE_DRAG_START_DURATION_MIN) &&
