...
Texture* CompressedTexture::createCompressedDdsKtx(const char* path) {
    int size;
...
Texture* CompressedTexture::createCompressedPVRTC(const char* path)
{
...
Texture* CompressedTexture::createCompressedDDS(const char* path)
{
    GP_ASSERT(path);
