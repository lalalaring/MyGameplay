...
public:
    ...
    */
    ...
    void createDepthStencilTarget(int format = 0);
     ...
     */
    FrameBuffer* bind(unsigned int type = 0x8D40/*GL_FRAMEBUFFER*/);
     ...
     */
    Image* createScreenshot(Image::Format format = Image::RGBA);
...
private:
    ...
    void setRenderTarget(RenderTarget* target, unsigned int index, unsigned int textureTarget);
    ...
    static std::vector<GLFrameBuffer*> _frameBuffers;
