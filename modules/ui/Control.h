...
public:
     ...
     *               One or more members of the Control::State enum, ORed together.
     */
    void setTextAlignment(Text::Justify alignment, unsigned char states = STATE_ALL);
     ...
     */
    Text::Justify getTextAlignment(State state = NORMAL) const;
...
protected:
     ...
     */
    void finishBatch(Form* form, BatchableLayer* batch);
