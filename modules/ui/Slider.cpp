...
Slider::Slider() : _min(0.0f), _max(0.0f), _step(0.0f), _value(0.0f), _delta(0.0f), _minImage(NULL),
    ...
    _valueTextAlignment(Text::ALIGN_BOTTOM_HCENTER), _valueTextPrecision(0), _valueText(""), 
...
void Slider::initialize(const char* typeName, Theme::Style* style, Properties* properties)
{
    ...
    if (properties)
    {
        ...
        {
            _valueTextAlignment = Text::getJustify(properties->getString("valueTextAlignment"));
        }
    }
...
void Slider::setValueTextAlignment(Text::Justify alignment)
{
    _valueTextAlignment = alignment;
}

Text::Justify Slider::getValueTextAlignment() const
{
