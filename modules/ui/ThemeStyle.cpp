...
Theme::Style::Overlay::Overlay()
    ...
    _fontSize(0), _alignment(Text::ALIGN_TOP_LEFT), _textRightToLeft(false), _textColor(Vector4::one()), _opacity(1.0f)
{
}
...
Text::Justify Theme::Style::Overlay::getTextAlignment() const
{
    return _alignment;
}

void Theme::Style::Overlay::setTextAlignment(Text::Justify alignment)
{
