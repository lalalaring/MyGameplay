...
private:
    ...
    QStandardItem* createSceneItem(gameplay::Scene *scene);
    QStandardItem* createObjectItem(gameplay::Node *object);
    QStandardItem* createScene(gameplay::Scene *scene);
    QStandardItem* createObjectHierarchy(gameplay::Node* object);
    void visitorAddItem(gameplay::Node *parent, QStandardItem* parentItem);
    void addToHiearchy(gameplay::Node *object, QStandardItem* item);
