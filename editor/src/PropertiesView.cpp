    ...
    _sceneView(nullptr)
{
    ...
    connect(_ui->lineEditName, SIGNAL(textEdited(QString)), this, SLOT(onNameChanged()));
...
void PropertiesView::onSelectionChanged()
{
    ...
    if (selectedObject != nullptr)
    {
        ...
        _ui->lineEditName->setText(selectedObject->getName());
        ...
        // Get the components
//        std::vector<gameplay::Ptr<gameplay::Component>> components = selectedObject->getComponents();
//        for (gameplay::Ptr<gameplay::Component> component : components)
//        {
