...
void Sprite::setBlendMode(BlendMode mode)
{
    switch (mode)
    {
        ...
        case BLEND_ALPHA:
            ...
            _batch->getStateBlock()->setBlendSrc(StateBlock::BLEND_SRC_ALPHA);
            _batch->getStateBlock()->setBlendDst(StateBlock::BLEND_ONE_MINUS_SRC_ALPHA);
            break;
        case BLEND_ADDITIVE:
            _batch->getStateBlock()->setBlend(true);
            _batch->getStateBlock()->setBlendSrc(StateBlock::BLEND_SRC_ALPHA);
            _batch->getStateBlock()->setBlendDst(StateBlock::BLEND_ONE);
            break;
        case BLEND_MULTIPLIED:
            _batch->getStateBlock()->setBlend(true);
            _batch->getStateBlock()->setBlendSrc(StateBlock::BLEND_ZERO);
            _batch->getStateBlock()->setBlendDst(StateBlock::BLEND_SRC_COLOR);
            break;
        default:
...
StateBlock* Sprite::getStateBlock() const
{
...
unsigned int Sprite::draw(RenderView* view)
{
