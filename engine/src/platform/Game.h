...
public:
     ...
     */
    void clear(Renderer::ClearFlags flags, const Vector4& clearColor, float clearDepth, int clearStencil);
     ...
     * @param clearStencil The stencil value to clear to when the flags includes the color buffer.
     */
    void clear(Renderer::ClearFlags flags, float red, float green, float blue, float alpha, float clearDepth, int clearStencil);
