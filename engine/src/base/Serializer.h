...
public:
    ...
    /**
     * Writes a anonymity Object.
     *
     * The developer must then call write* for the count of strings.
     *
     ...
     */
    virtual void writeMap(const char*propertyName, std::vector<std::string> &keys) = 0;
     ...
     */
    virtual void writeList(const char* propertyName, size_t count) = 0;

    /**
     * End read/write the List or Map
     */
    virtual void finishColloction() = 0;
     ...
     */
    virtual void readMap(const char* propertyName, std::vector<std::string> &keys) = 0;
     ...
     */
    virtual size_t readList(const char* propertyName) = 0;
