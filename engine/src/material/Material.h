 ...
 */
class Material : public Ref, public Serializable
{
...
public:
     ...
     * @script{create}
     */
    static Material* create(ShaderProgram* effect);
     ...
     */
    void bind(RenderView* view, Node* node);
...
private:
    ...
    /**
     * Collection of MaterialParameter's to be applied to the gameplay::ShaderProgram.
     */
