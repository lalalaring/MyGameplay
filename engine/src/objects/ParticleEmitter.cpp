...
void ParticleEmitter::setBlendMode(BlendMode blendMode)
{
    ...
    switch (blendMode)
    {
        ...
        case BLEND_ALPHA:
            ...
            _spriteBatch->getStateBlock()->setBlendSrc(StateBlock::BLEND_SRC_ALPHA);
            _spriteBatch->getStateBlock()->setBlendDst(StateBlock::BLEND_ONE_MINUS_SRC_ALPHA);
            break;
        case BLEND_ADDITIVE:
            _spriteBatch->getStateBlock()->setBlend(true);
            _spriteBatch->getStateBlock()->setBlendSrc(StateBlock::BLEND_SRC_ALPHA);
            _spriteBatch->getStateBlock()->setBlendDst(StateBlock::BLEND_ONE);
            break;
        case BLEND_MULTIPLIED:
            _spriteBatch->getStateBlock()->setBlend(true);
            _spriteBatch->getStateBlock()->setBlendSrc(StateBlock::BLEND_ZERO);
            _spriteBatch->getStateBlock()->setBlendDst(StateBlock::BLEND_SRC_COLOR);
            break;
        default:
...
unsigned int ParticleEmitter::draw(RenderView* view)
{
    if (!isActive())
        return 0;
